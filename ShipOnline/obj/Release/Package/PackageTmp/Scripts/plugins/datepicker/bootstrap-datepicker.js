...
(function ($, undefined) {
    ...
    var Datepicker = function (element, options) {
        ...
        this.component = this.element.is('.date') ? this.element.find('.add-on, .input-group-addon, .btn:not(.btnToday)') : false;
	...
	* ================== */
    ...
    $(function () {
        ...
        // unbind show calendar when focus on textbox, only show by click button calendar
        $(document).off('.date > input, .display-date');
        $(document).on('focus', '.date > input, .display-date', function (e) {
