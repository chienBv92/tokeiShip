...
{
    public class AdminOrderShipController : BaseController
    {
        //
        // GET: /OrderShip/
        ...
        public ActionResult AdminOrderShipList()
        {
            ...
            model.GROUP_CD_RECEIVE_LIST.Insert(0, new SelectListItem { Value = Constant.DEFAULT_VALUE, Text = "" });
            ...
            model.GROUP_CD_SENDER_LIST.Insert(0, new SelectListItem { Value = Constant.DEFAULT_VALUE, Text = "" });
